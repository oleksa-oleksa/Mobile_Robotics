...
from assignment8.msg import MsgDrive
...
def callbackDrive(msgDrive):
    drive(hc_distance, "pidDrive", msgDrive.speed, msgDrive.angle)
...
def drive(distance, command, speed, angle):
    ...
    pub_speed.publish(0) # TODO Test without this line somehow somewhere.
...
sub_drive = rospy.Subscriber(
    "pid/drive", MsgDrive, callbackDrive, queue_size=10)
