...
class CarPosition:
    ...
    def odom_callback(self, data):
        ...
        current_angle = utils.get_angle(current_w)
        ...
        # closest_outer, distance_outer = assignment10.get_closest_point(
        #     current_y,
        #     current_x,
        #     self.outer_track
        # )
        #
        # expected_point_outer = assignment10.get_point_to_distance(
        #     self.outer_track,
        #     (current_y, current_x),
        #     closest_outer,
        #     self.distance
        ...
        expected_coordinates.expected_x = expected_point_inner[0]
        expected_coordinates.expected_y = expected_point_inner[1]
